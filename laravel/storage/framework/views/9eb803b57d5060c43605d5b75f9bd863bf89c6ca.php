                ...
                <div class="container">
                    ...
                    <ul class="col-xs-12 col-sm-7 list-unstyled">
                        <li class="text-right pull-right">
                            <a href="<?php echo e(url('contact')); ?>" title="Liên hệ">Liên hệ</a> - <a href="<?php echo e(url('tos')); ?>" title="Terms of Service">Điều khoản</a> <a class="backtop" href="#backOnTop" rel="nofollow"><span class="glyphicon glyphicon-upload"></span></a>
                        </li>
